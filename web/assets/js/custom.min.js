        ...
        methods: {
            updateCategory: function (event) {
                ...
                .then(function (response) {
                    var category = JSON.parse(response.data.category);
                    $('.edit-modal').modal('show');
                    $('#st0ik_edit_foodosbundle_category_title').val(category.title);
                    $('#st0ik_edit_foodosbundle_category_weight').val(category.weight);
                    $('#st0ik_edit_foodosbundle_category_description').val(category.description);
                    $('.ajaxCategoryEdit').attr('action','/app_dev.php/backend/catalog/ajaxCategoryEdit/' + category.id);
                })
